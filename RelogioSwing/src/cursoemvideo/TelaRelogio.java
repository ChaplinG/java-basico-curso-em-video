...
public class TelaRelogio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("cursoemvideo/Bundle"); // NOI18N
        jLabel1.setText(bundle.getString("TelaRelogio.jLabel1.text")); // NOI18N

        jLabel2.setText(bundle.getString("TelaRelogio.jLabel2.text")); // NOI18N

        lblHora.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        lblHora.setForeground(new java.awt.Color(51, 102, 0));
        lblHora.setText(bundle.getString("TelaRelogio.lblHora.text")); // NOI18N

        btnHora.setText(bundle.getString("TelaRelogio.btnHora.text")); // NOI18N
